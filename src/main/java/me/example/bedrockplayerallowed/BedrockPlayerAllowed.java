package me.example.bedrockplayerallowed;
...
public class BedrockPlayerAllowed extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        getLogger().info("BedrockPlayerAllowed Plugin Enabled!");
    }
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        if (!isFloodgatePlayer && !playerName.equalsIgnoreCase(allowedJavaUsername)) {
            event.getPlayer().kickPlayer("❌ Only Bedrock players and admin are allowed.");
        }
    }
}
